const en = {
  ...
  whyHeading1: "Portugal's most",
  whyHeading2: "iconic pastry",

  whyText:
    "Pastéis de Nata are one of Portugal's most loved bakery products—perfect with coffee and suitable for sales throughout the day.",

  storyTitle: "Ideal for premium everyday sales",
  ...
  authentic: "Authentic",
  authenticText:
    "Handmade in Portugal using a traditional Portuguese recipe.",

  flexible: "Flexible",
  flexibleText:
    "Bake fresh throughout the day according to your sales demand.",

  consistent: "Consistent",
  consistentText:
    "Reliable quality every batch with simple bake-off preparation.",
...
========================== */
  ...
  wholesalePricingTier0: "1–4 boxes",
